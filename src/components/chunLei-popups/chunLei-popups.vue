<template>
	<view class="mask" :class="!show?'':'mask-show'" :style="{backgroundColor:show?maskBg:'rgba(0,0,0,0)'}" @tap.stop="tapMask" @touchmove.stop="">
		<view class="popups" :class="[theme]"
			:style="{'--radius':radius, '--padding': padding,  top: popupsTop ,left: popupsLeft,flexDirection:direction}">
